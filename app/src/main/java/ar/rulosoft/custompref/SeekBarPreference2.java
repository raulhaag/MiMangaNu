...
public class SeekBarPreference2 extends Preference implements OnSeekBarChangeListener, View.OnKeyListener {
    ...
    public SeekBarPreference2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onInfoChanged() {
        ...
        for (Map.Entry<TextView, SeekBarPreference2> entry : mInfoViews.entrySet()) {
